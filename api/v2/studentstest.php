...
if ($_SERVER['REQUEST_METHOD']=='GET'){
	...
	//echo "<script>console.log('Debug Objects: " . $str_json . "' );</script>";
}
...
function createstudent($json){
	...
	if($jsonobj->apikey==$apikey){
		...
		if($jsonobj->parents->mother_surname==""&&$jsonobj->parents->mother_lastname==""&&$jsonobj->parents->father_surname=""&&$jsonobj->parents->father_lastnam="")
		{
		$jsonobj->parents->mother_surname="keine Angabe";
		$jsonobj->parents->mother_lastname="keine Angabe";
		$jsonobj->parents->father_surname="keine Angabe";
		$jsonobj->parents->father_lastname="keine Angabe";
		}
