    ...
    <header>
      <div class="jumbotron">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <h1 class="text-center">Verwaltung</h1>
              <p class="text-center">Schüler anlegen usw</p>
              <p>&nbsp;</p>
              <p class="text-center"><a class="btn btn-primary btn-lg" href="#" role="button">mehr</a> </p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container ">
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-12 text-center">
            <img class="rounded-circle" alt="140x140" style="width: 140px; height: 140px;" src="file:///C|/Users/Sebastian/AppData/Roaming/Adobe/Dreamweaver CC 2019/de_DE/Configuration/Temp/Assets/eam656E.tmp/images/140X140.gif" data-holder-rendered="true">
            <h3>Lorem ipsum</h3>
...
-->
    <footer class="text-center">
      <div class="container">
        <div class="row">
          <div class="col-12">
            <p>Copyright ©Friedrich-List-Schule, Sebastian Reinhold, All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
