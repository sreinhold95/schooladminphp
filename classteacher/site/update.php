				...
				<table class="table" id="anlegen-table" >	
					...
					<tr>
						<td>
							...
							<input class="eltern" type="number" size="24" maxlength="50" name="address" id="mother_postalcode" onchange='settown("input#mother_postalcode","mother_town","false")'value="<?php echo $get['mother_postalcode']?>">
						...
						<td>
							...
							<label for="surname" class="label">PLZ:</label>
							<input class="eltern" type="number" size="24" maxlength="50" name="address" id="father_postalcode" onchange='settown("input#father_postalcode","father_town","false")' value="<?php echo $get['father_postalcode']?>">
							...
							<!--</select>-->
							<label for="givenname" class="label">Ort:</label>
							<input class="field" type="text" size="24" maxlength="50" name="givenname" id="father_town" value="<?php if(mb_detect_encoding ($get[ 'father_town' ])=="UTF-8") echo utf8_decode($get['father_town']); else echo $get['father_town']; ?>">
							<label for="address" class="label">Telefon:</label>
