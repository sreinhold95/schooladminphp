...
<div class="table_wrap">
	<table class="table" id="user-table">
		...
		$query = $mysqli->query( "SELECT students.surname,students.middlename,students.givenname,students.moregivenname,students.active FROM students,class where students.classcode=class.classcode and students.idstudents='" . $_SESSION[ 'idstudents' ] . "';" );
		if ( $query->num_rows ) {
	...
	<div class="add_wrap">
		...
		<div class="box">
			<form method="POST" action="" id="useranlegen" class="form">
				...
				<label for="surname" class="label">Straße:</label>
				<input class="field" type="text" size="24" maxlength="50" name="street" id="street">
