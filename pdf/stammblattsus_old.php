...
$query = $mysqli->query( "SELECT * from all_studentspdf inner join teacher_class on all_studentspdf.classcode=teacher_class.classcode inner join teacher on teacher_class.idteacher=teacher.idteacher where all_studentspdf.active=1 and all_studentspdf.idstudents='".$idstudent."' and teacher_class.idteacher='".$idteacher."'");
if ( $query->num_rows ) {
    $html=array();
    $i=0;
        ...
        if($get["Schulform"]=="Teilzeit")
        {
            ...
            <tr>
                ...
                <tbody>
                    ...
                    <br>
                    <h4>-abgehende Schule-</h4>
                    <table border="0" >
                    <tr>
                        <td width="150"><b>Schulename:</b></td>
                        <td width="469">'.$get[ 'lastschool' ].'</td>
                    </tr>
                    <tr>
                        <td><b>Ort der Schule</b></td>
                        <td width="150">'.$get[ 'lastschooltown' ].'</td>
        ...
        }else if($get["Schulform"]=="Vollzeit")
        {
            ...
            <table cellpadding="1" cellspacing="1" border="0">
                ...
                <tr>
                    ...
                    <td width="439">'.$get[ 'lastschooltown' ].'</td>
                </tr>
                <tr>
...
$pdf->SetTitle('Stammblätter ');
$pdf->SetSubject('Stammblätter ');
...
foreach($html as $page){
    $pdf->AddPage();
// Fügt den HTML Code in das PDF Dokument ein
    $kopie ='<h1>SuS Kopie</h1>';
    $kopie .=$page;
    $pdf->writeHTML($kopie, true, false, true, false, '');
}
//$pdf->AddPage();
// Fügt den HTML Code in das PDF Dokument ein
