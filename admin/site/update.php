				...
				<table class="table" id="anlegen-table">
					...
					<tr>
						...
						<td>
							...
							<input class="field" type="text" size="24" maxlength="100" name="email" id="email" value="<?php echo $get['email']; ?>">
				...
				?>
					...
					<tr>
						<td>
							...
							<input class="field" type="text" size="24" maxlength="100" name="religion" id="ausbildungsbetrieb_email"  value="<?php echo $get['Ausbildungsbetrieb_Email']; ?>">
						</td>
						<td>
