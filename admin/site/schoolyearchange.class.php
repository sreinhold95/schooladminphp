    ...
    <div class="container">
        <div class="row">
            <form class="form-horizontal" action="function.php" method="post" name="import_teacher" enctype="multipart/form-data">
                <fieldset>
                    <!-- Form Name -->
                    <legend>Wechseln in das nächste Schuljahr</legend>
                    <!-- Button -->
                    <div class="form-group">
                        <!-- <label class="col-md-4 control-label" for="singlebutton">Import data</label> -->
                        <div class="col-md-4">
                            <button type="submit" id="submit" name="schoolyearchange" class="btn btn-primary button-loading" data-loading-text="Loading...">ausführen</button>
                        </div>
                    </div>
                </fieldset>
            </form>
