				...
				<table class="table" id="Ausbildungsbetrieb-table" style="display:none" >
					...
					<tr>
						<td>
							...
							<input class="opt" type="text" size="24" maxlength="50" name="ausbildungsbetrieb_name" id="ausbildungsbetrieb_name" onchange='stringreplace("input#ausbildungsbetrieb_name","ausbildungsbetrieb_name","&"," und ")'>
						</td>
						<td>
							</td>
					</tr>
					<tr>
						<td>
							...
							<input class="opt" type="txt" size="24" maxlength="50" name="ausbildungsbetrieb_email" id="ausbildungsbetrieb_email">
