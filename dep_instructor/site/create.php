	...
	<div class="schüler_create_wrap">
		...
		<div class="box">
			<form method="POST" action="" id="useranlegen" class="form">
				<table class="table" id="anlegen-table">
					...
					<tr>
						<td>
							...
							<input class="field" type="number" size="24" maxlength="50" name="postalcode" id="postalcode" onchange='settown("input#postalcode","town","true")'>
							...
							<label for="birthtown" class="label">Geburtsort(Stadt/Ort):</label>
						...
						<td>-->
							...
							<input class="opt" type="text" size="24" maxlength="50" name="religion" id="religion">
							...
							<input class="opt" type="text" size="24" maxlength="100" name="email" id="email">
				...
				<table class="table" id="Ausbildungsbetrieb-table" style="display:none" >
					...
					<tr>
						<td>
							...
							<input class="opt" type="text" size="24" maxlength="100" name="ausbildungsbetrieb_name" id="ausbildungsbetrieb_name" onchange='stringreplace("input#ausbildungsbetrieb_name","ausbildungsbetrieb_name","&"," und ")'>
						</td>
						<td>
							</td>
					</tr>
					<tr>
						<td>
							...
							<input class="opt" type="text" size="24" maxlength="50" name="ausbildungsbetrieb_strasse" id="ausbildungsbetrieb_strasse">
							<label class="label">PLZ:</label>
							<input class="opt" type="number" size="24" maxlength="50" name="ausbildungsbetrieb_plz" id="ausbildungsbetrieb_plz" onchange='settown("input#ausbildungsbetrieb_plz","ausbildungsbetrieb_ort","true")'>
							<label class="label">Ort:</label>
							<input class="opt" type="text" size="24" maxlength="50" name="ausbildungsbetrieb_ort" id="ausbildungsbetrieb_ort">
							<label class="label">Email:</label>
							<input class="opt" type="txt" size="24" maxlength="100" name="ausbildungsbetrieb_email" id="ausbildungsbetrieb_email">
						...
						<!--<td>
						<label class="label">PLZ:</label>
						<input class="opt" type="txt" size="24" maxlength="50" name="religion" id="ausbildungsbetrieb_plz">
				...
				<table class="table" id="Schulbildung-table">
					...
					<tr id="Abgang" style="display:none">
						...
						<label class="label">Abgang:</label>
							<input class="opt" type="date" size="24" maxlength="50" name="lastschooldate" id="lastschooldate">
					</tr>
				...
				<table class="table" id="anlegen-table" >	
					<tr>
						<th>zusätzliche Informationen der Eltern</th>
					...
					<tr>
						<td>
							...
							<input class="eltern" type="number" size="24" maxlength="50" name="address" id="mother_plz" onchange='settown("input#mother_plz","mother_town","false")'>
						...
						<td>
							...
							<label for="surname" class="label">PLZ:</label>
							<input class="eltern" type="number" size="24" maxlength="50" name="address" id="father_plz" onchange='settown("input#father_plz","father_town","false")'>
							<label for="givenname" class="label">Ort:</label>
			...
			var users = JSON.parse(xhr.responseText);
				if (xhr.readyState == 4 && xhr.status == "200") {
					...
					if(users.success){
						...
						window.location.replace('../dep_instructor/index.php?site=home');
					}
				} else {
					console.error(users);
				}
